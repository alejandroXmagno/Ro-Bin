...
#include "geometry_msgs/msg/detail/twist__functions.h"  // move_goal
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: move_goal
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->move_goal, cdr))
    {
      return false;
    }
  }

  // Field name: move_goal_lin_x
  {
    cdr << ros_message->move_goal_lin_x;
  }

  // Field name: move_goal_ang_z
  {
    cdr << ros_message->move_goal_ang_z;
  }

  // Field name: time_goal
  {
    cdr << ros_message->time_goal;
  }
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Twist(
    &(ros_message->move_goal), current_alignment);
  // field.name move_goal_lin_x
  {
    size_t item_size = sizeof(ros_message->move_goal_lin_x);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name move_goal_ang_z
  {
    size_t item_size = sizeof(ros_message->move_goal_ang_z);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name time_goal
  {
    size_t item_size = sizeof(ros_message->time_goal);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
