...
class Move_Goal(metaclass=Metaclass_Move_Goal):
    ...
    _fields_and_field_types = {
        'move_goal': 'geometry_msgs/Twist',
        'move_goal_lin_x': 'float',
        'move_goal_ang_z': 'float',
        'time_goal': 'int32',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from geometry_msgs.msg import Twist
        self.move_goal = kwargs.get('move_goal', Twist())
        self.move_goal_lin_x = kwargs.get('move_goal_lin_x', float())
        self.move_goal_ang_z = kwargs.get('move_goal_ang_z', float())
        self.time_goal = kwargs.get('time_goal', int())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.move_goal != other.move_goal:
            return False
        if self.move_goal_lin_x != other.move_goal_lin_x:
            return False
        if self.move_goal_ang_z != other.move_goal_ang_z:
            return False
        if self.time_goal != other.time_goal:
            return False
        return True
    ...
    @builtins.property
    def move_goal(self):
        """Message field 'move_goal'."""
        return self._move_goal

    @move_goal.setter
    def move_goal(self, value):
        if __debug__:
            from geometry_msgs.msg import Twist
            assert \
                isinstance(value, Twist), \
                "The 'move_goal' field must be a sub message of type 'Twist'"
        self._move_goal = value

    @builtins.property
    def move_goal_lin_x(self):
        """Message field 'move_goal_lin_x'."""
        return self._move_goal_lin_x

    @move_goal_lin_x.setter
    def move_goal_lin_x(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'move_goal_lin_x' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'move_goal_lin_x' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._move_goal_lin_x = value

    @builtins.property
    def move_goal_ang_z(self):
        """Message field 'move_goal_ang_z'."""
        return self._move_goal_ang_z

    @move_goal_ang_z.setter
    def move_goal_ang_z(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'move_goal_ang_z' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'move_goal_ang_z' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._move_goal_ang_z = value

    @builtins.property
    def time_goal(self):
        """Message field 'time_goal'."""
        return self._time_goal

    @time_goal.setter
    def time_goal(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'time_goal' field must be of type 'int'"
            assert value >= -2147483648 and value < 2147483648, \
                "The 'time_goal' field must be an integer in [-2147483648, 2147483647]"
        self._time_goal = value
