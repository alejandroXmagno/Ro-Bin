...
"""
Simulation Launch File for Autonomous SLAM and Exploration
Launches the mini rover in Gazebo simulation with LIDAR SLAM, navigation, and autonomous exploration
"""
...
def generate_launch_description():
    ...
    rover_gazebo_dir = get_package_share_directory('roverrobotics_gazebo')
    ...
    declare_world_arg = DeclareLaunchArgument(
        ...
        description='Gazebo world to load (warehouse, maze, etc.)'
    )
    ...
    gazebo_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(rover_gazebo_dir, 'launch', '2wd_rover_gazebo.launch.py')
        ),
        launch_arguments={
            'world': world
        }.items()
